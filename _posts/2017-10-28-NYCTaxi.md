...
## Q10. Which trips can we confidently use means as measures of central tendency to estimate fares, time taken etc.
...
## Q11. Linear model of Taxi Fare given pickup and dropoff location
...
It would be interesting to see the impact of services such as Uber or Lyft on taxi demand over time. Also of interest is whether the precipation or temperature on a particular day has an effect on demand and taxi fare.
