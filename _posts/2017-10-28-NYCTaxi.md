...
Figure 13 plots all routes that generate that highest daily revenue and the total number of trips required to generate this revenue. I note these trips are all based in Manhattan, except for one which is from Manhattan to La Guardia Airport.
...
A taxi owner could prioritize taxi bookings for these trips.

A taxi owner could ensure they meet a daily threshold via their Manhattan trips before undertaking other trips outside this zone.
