...
A Least Squares Regression model that uses trip time, distance, speed, tip amount and tolls amount to predict fare amount has an R-square higher than 90%. I show a line of best fit among the fare data in Figure 12 below. 
...
Note the scatter plot of predicted versus actual fares shows a cluster of fares at the $50 mark, which requires further investigation. Either these fares were rounded or mis-reported by the taxi drivers.

## Q12. If you were a taxi owner, how would you maximize your earnings in a day?

As I've excluded "out of town" fares i.e. any trips to Nassau county or Westchester, my analysis will focus on all trips within New York city and its airports. I note that the trips with the minimum standard deviation of travel times 
