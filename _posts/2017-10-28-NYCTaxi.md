...
Before answering this and the next question, it is important to determine what minimum sample size to use. If there is a record of a unique trip for example, then the standard deviation of that trip's travel time is zero. What minimum sample size do we need to determine the standard deviation of trip times?
...
Travel times for trips originating from La Guardia airport to New York's boroughs have the largest variance. Apparently, airport traffic can be a nightmare. 
