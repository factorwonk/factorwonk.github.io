...
Interestingly, these trips begin and end at the same geocode (rounded to 2 d.p.) and are all intra-Manhattan or intra-Airport trips, indicating that these shorter trips can be used to maximize daily earnings.
