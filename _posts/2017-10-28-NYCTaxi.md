...
## Rudimentary model of Taxi Fare

A Least Squares Regression model that uses trip time, distance, speed, tip amount and tolls amount to predict fare amount has an R-square of 95.6%. I show a line of best fit among the fare data in Figure 11 below. Note the scatter plot of predicted versus actual fares shows a cluster of fares at the $50 mark, which requires further investigation. Either these fares were rounded or mis-reported.
