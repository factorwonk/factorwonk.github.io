...
**Multi-Label Classification: Placing in the Top 20% of the Kaggle Seedlings Competition**<br /> <br />While the previous model was used for single label classification
