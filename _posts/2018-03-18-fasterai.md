...
This time our final activation layer is not a sigmoid function as we're trying to distinguish between 12 different plant seedling types. Instead we use a softmax layer as the final activation function.
