...
This post has been updated to reflect the comments of BCGDV Data Scientist. The repository containing code for both sections is [here](https://github.com/factorwonk/bcgdv) and the presentation is available in pdf format [here](https://factorwonk.github.io/bcgdv.pdf) and in powerpoint format [here](https://factorwonk.github.io/bcgdv.ppt).
