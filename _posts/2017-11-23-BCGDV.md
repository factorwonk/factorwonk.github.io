...
I decided to use a Logistic Classifier as it transforms an underlying linear model using a sigmoid function to provide a binary outcome. The interpretation is more intuitive than a Random Forest Classifier for example. 
