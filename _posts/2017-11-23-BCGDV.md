...
The first outcome of my EDA is the distribution of the target variable, 70% of which are Class 1 and 30% are Class 0. This leads to an imbalanced class problem. Any model that simply predicts all values of the target variable are 1 will have an accuracy of 70%. The area under the ROC curve is a metric which is not affected by this imbalanced class problem and the metric I will try to maximize. 

Figure 5 examines the distribution of all features and target values. 
