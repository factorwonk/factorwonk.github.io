...
While the illustrated ROC curve has a score of 79%, running a 10 fold cross-validation across the sample, drops the area under the curve to 76.1%. I list the top 5 important features in Figure 7 below. A linear combination of A6-A10 and A13 has the highest predictive power for the Logistic Classifier.
