...
1. Low speeds and Low values of variables of interest
2. Low speeds and High values of variables of interest
3. High speeds and High values of variables of interest
