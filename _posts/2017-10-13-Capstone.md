...
This is corroborated by a simple OLS regression model that uses whether a driver had an accident or not as the target and the cognitive, empathy and personality factors as its features.


*Figure 2: OLS reveals most personality features are not significant *

![_config.yml]({{ site.baseurl }}/images/accidentOLS.png)
